...
```bash
git remote add encore encore://modern-e-commerce-platform-v7s2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/modern-e-commerce-platform-v7s2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/modern-e-commerce-platform-v7s2/settings/integrations/github)
