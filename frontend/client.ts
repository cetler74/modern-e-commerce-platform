...
export namespace analytics {
    ...
    export class ServiceClient {
         ...
         */
        public async getDashboardMetrics(params: RequestType<typeof api_analytics_dashboard_getDashboardMetrics>): Promise<ResponseType<typeof api_analytics_dashboard_getDashboardMetrics>> {
...
export namespace cms {
    ...
    export class ServiceClient {
         ...
         * Create blog post
         */
        public async createBlogPost(params: RequestType<typeof api_cms_blog_createBlogPost>): Promise<ResponseType<typeof api_cms_blog_createBlogPost>> {
            // Now make the actual call to the API
         ...
         * List blog posts
         */
        public async listBlogPosts(params: RequestType<typeof api_cms_blog_listBlogPosts>): Promise<ResponseType<typeof api_cms_blog_listBlogPosts>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                limit:  params.limit === undefined ? undefined : String(params.limit),
...
export namespace products {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { identifier: string }): Promise<ResponseType<typeof api_products_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/${encodeURIComponent(params.identifier)}`, {method: "GET", body: undefined})
...
export namespace subscriptions {
    ...
    export class ServiceClient {
         ...
         */
        public async updateSubscription(params: RequestType<typeof api_subscriptions_manage_updateSubscription>): Promise<ResponseType<typeof api_subscriptions_manage_updateSubscription>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_subscriptions_manage_updateSubscription>
        }
    }
}
